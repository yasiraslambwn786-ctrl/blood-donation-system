          ...
          <div className="col-12 col-lg-6 col-xl-7">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-11">
                <h2 className="h1 mb-3">About Our Software Engineering Team</h2>
                  ...
                  <div className="col-12 col-md-6">
                    <div className="d-flex">
                      ...
                      <div>
                        ...
                        <p className="text-secondary mb-0">We focus on crafting innovative software solutions that solve real-world challenges.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-md-6">
                    <div className="d-flex">
                      ...
                      <div>
                        <h4 className="mb-3">Digital Excellence</h4>
                        <p className="text-secondary mb-0">We strive for digital excellence, ensuring our software meets the highest standards of quality and performance.</p>
                      </div>
                    </div>
                  </div>
                </div>
